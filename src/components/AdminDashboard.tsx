  ...
  return (
    <div className="min-h-screen bg-neutral-50/50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 space-y-6">
        ...
        {/* SECTION 1.5: PENDING LISTINGS TAB (Firestore query where status == "pending") */}
        {activeTab === 'pending-listings' && (
          <div className="space-y-4">
            <div className="p-4 bg-white dark:bg-neutral-900 rounded-2xl border border-amber-200 dark:border-amber-900/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-2xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-[10px] font-mono font-black uppercase px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-300 border border-amber-300 dark:border-amber-800 flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
                      Firestore: where('status', '==', 'pending')
                    </span>
                  </div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5 font-medium">
                    All accommodation listings with status equal to "pending" queried directly from Firestore. Review, approve or reject submissions.
                  </p>
                </div>
              </div>

              <div className="self-end sm:self-auto shrink-0">
                <span className="px-3 py-1.5 rounded-xl bg-amber-100 dark:bg-amber-950 text-amber-900 dark:text-amber-300 border border-amber-300 dark:border-amber-800 text-xs font-black">
                  {pendingListings.length} {pendingListings.length === 1 ? 'Pending Submission' : 'Pending Submissions'}
                </span>
              </div>
            </div>
            ...
            {isLoadingPendingListings ? (
              <div className="p-12 text-center bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800">
                <Clock className="w-8 h-8 text-amber-500 animate-spin mx-auto mb-3 opacity-80" />
                <h3 className="font-bold text-base text-neutral-900 dark:text-white">Querying Firestore...</h3>
                <p className="text-xs text-neutral-500 mt-1">Loading listings with status == "pending"</p>
              </div>
            ) : pendingListings.length === 0 ? (
              <div className="p-12 text-center bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800">
                <CheckCircle2 className="w-12 h-12 text-emerald-500 mx-auto mb-3" />
                <h3 className="font-bold text-base text-neutral-900 dark:text-white">No Pending Listings</h3>
                <p className="text-xs text-neutral-500 mt-1 max-w-md mx-auto">
                  All property listing submissions have been processed! No listings currently match status == "pending".
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 gap-4">
                {pendingListings
                  ...
                  .map((prop) => (
                    <div 
                      key={`pending_tab_${prop.id}`}
                      className="bg-white dark:bg-neutral-900 rounded-2xl border border-amber-200 dark:border-amber-900/60 p-5 shadow-2xs hover:border-amber-400 transition-all flex flex-col md:flex-row items-start md:items-center justify-between gap-5"
                    >
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span className="text-[10px] font-black uppercase px-2.5 py-0.5 rounded-md bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-300 border border-amber-300 dark:border-amber-800 flex items-center gap-1">
                      ...
                      <div className="flex items-center gap-2 self-end md:self-center shrink-0">
                        ...
                        <button
                          ...
                          className="px-3.5 py-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-900/60 font-bold text-xs transition-all flex items-center gap-1 cursor-pointer"
                        >
